...
Um sistema robusto de chat distribuído *peer-to-peer* com comunicação baseada em RPC, difusão de mensagens e consistência de histórico replicado. Desenvolvido como projeto prático para a disciplina de **Algoritmos e Estruturas de Dados II** no Instituto de Informática (INF) da **Universidade Federal de Goiás (UFG)**.
